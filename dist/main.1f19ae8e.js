...
},{"./Observer.js":"../node_modules/gsap/Observer.js"}],"../node_modules/gsap/utils/matrix.js":[function(require,module,exports) {
"use strict";
...
},{"./utils/matrix.js":"../node_modules/gsap/utils/matrix.js"}],"main.js":[function(require,module,exports) {
"use strict";
...
_gsap.default.set(".box", {
  yPercent: -50
});
var STAGGER = 0.1;
var DURATION = 1;
var OFFSET = 0;
var BOXES = _gsap.default.utils.toArray(".box");
var LOOP = _gsap.default.timeline({
  paused: true,
  repeat: -1,
  ease: "none"
});
var SHIFTS = [].concat(_toConsumableArray(BOXES), _toConsumableArray(BOXES), _toConsumableArray(BOXES));
SHIFTS.forEach(function (BOX, index) {
  var BOX_TL = _gsap.default.timeline().set(BOX, {
    xPercent: 250,
    rotateY: -50,
    opacity: 0,
    scale: 0.5
...
var CYCLE_DURATION = STAGGER * BOXES.length;
var START_TIME = CYCLE_DURATION + DURATION * 0.5 + OFFSET;
var LOOP_HEAD = _gsap.default.fromTo(LOOP, {
...
var POSITION_WRAP = _gsap.default.utils.wrap(0, LOOP_HEAD.duration());
var SCRUB = _gsap.default.to(PLAYHEAD, {
  position: 0,
...
var iteration = 0;
var TRIGGER = _ScrollTrigger.default.create({
  start: 0,
  end: "+=2000",
  horizontal: false,
  pin: ".boxes",
  onUpdate: function onUpdate(self) {
    ...
    if (SCROLL > self.end - 1) {
      ...
      var NEW_POS = (iteration + self.progress) * LOOP_HEAD.duration();
      SCRUB.vars.position = NEW_POS;
      SCRUB.invalidate().restart();
    }
  }
});
var WRAP = function WRAP(iterationDelta, scrollTo) {
  iteration += iterationDelta;
  TRIGGER.scroll(scrollTo);
  TRIGGER.update();
};
var SNAP = _gsap.default.utils.snap(1 / BOXES.length);
var progressToScroll = function progressToScroll(progress) {
  return _gsap.default.utils.clamp(1, TRIGGER.end - 1, _gsap.default.utils.wrap(0, 1, progress) * TRIGGER.end);
};
var scrollToPosition = function scrollToPosition(position) {
  var SNAP_POS = SNAP(position);
  var PROGRESS = (SNAP_POS - LOOP_HEAD.duration() * iteration) / LOOP_HEAD.duration();
  var SCROLL = progressToScroll(PROGRESS);
  if (PROGRESS >= 1 || PROGRESS < 0) {
    return WRAP(Math.floor(PROGRESS), SCROLL);
  }
  TRIGGER.scroll(SCROLL);
};
_ScrollTrigger.default.addEventListener("scrollEnd", function () {
  return scrollToPosition(SCRUB.vars.position);
});
var NEXT = function NEXT() {
  return scrollToPosition(SCRUB.vars.position - 1 / BOXES.length);
};
...
document.querySelector(".boxes").addEventListener("click", function (_ref) {
  var target = _ref.target;
  var BOX = target.closest(".box");
  if (BOX) {
    var TARGET = BOXES.indexOf(BOX);
    var CURRENT = _gsap.default.utils.wrap(0, BOXES.length, Math.floor(BOXES.length * SCRUB.vars.position));
    var BUMP = TARGET - CURRENT;
...
_gsap.default.set("button", {
  z: 200
});
_Draggable.default.create(".drag-proxy", {
  type: "x",
  trigger: ".box",
...
},{"gsap":"../node_modules/gsap/index.js","gsap/ScrollTrigger":"../node_modules/gsap/ScrollTrigger.js","gsap/Draggable":"../node_modules/gsap/Draggable.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
